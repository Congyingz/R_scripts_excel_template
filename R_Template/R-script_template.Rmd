...
Layer 0 folder (root folder): E.g. R_Template
...
knitr::opts_knit$set(root.dir = "C:/Users/xima/Desktop/R_Template") # Change working directory to the layer 0 folder location (play button #1) or manually set working directory (follow provided word file for instruction and do not press play button #1).
```
...
conditions_lookup <- data.frame(
  ...
  remove4C_condition = c(300000, 300000, 300000), # Examples are used here. Replace with your >4C cut-off values.
  removeDebris_condition = c(50000, 50000, 50000) # Examples are used here. Replace with your debris cut-offs values.
)
...
thresholds_visual <- data.frame(AnimalID = unique(testis_comets_testis$AnimalID),
                                Threshold = c(115000, 110000, 105000)) #Examples are used here. Replace with your Tot_Int threshold value for each animal. 
